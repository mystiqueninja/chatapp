  ...
  render: function () {
    return (
      React.createElement("div", {className: "message"}, 
        React.createElement("b", null, this.props.user), ": ", this.props.text
      )
    );
  }
});
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function () {
    return (
      React.createElement("form", {ref: "send", onSubmit: this.submitHandle}, 
        React.createElement("textarea", {onKeyUp: this.keyUpHandle, onChange: this.changeHandle, value: this.state.text})
      )
    );
  }
});
